...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect("admin/produk")->with('status', $validator->errors()->first());
        }
        DB::beginTransaction();
        try {
            //code...
            ...
            //commit
            DB::commit();
            return redirect("admin/produk")->with('status', "Sukses menambhakan produk");
        } catch (\Exception $e) {
            DB::rollback();
            $ea = "Terjadi Kesalahan saat menambahkan kategori".$e->message;
            return redirect("admin/produk")->with('status', $ea);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            //commit
            DB::commit();
            return redirect("admin/produk")->with('status', "Sukses merubah produk");
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function destroy($id)
    {
        ...
        try{
            ...
            $delete = ImagesProduct::where('product_id',$id)->delete();
            DB::commit();
            return redirect("admin/produk")->with('status', "Sukses menghapus product");
