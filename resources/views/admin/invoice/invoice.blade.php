                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success" href="{{ route('print_invoice',$item->id) }}?rev={{ $item->rev }}" target="_blank"><span class="fas fa-eye"></span></a>
                            <a class="btn btn-warning" href="{{ route('surat_jalan',$item->id) }}?rev={{ $item->rev }}" target="_blank"><span class="fas fa-eye"></span></a>
