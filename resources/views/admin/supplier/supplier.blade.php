          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="{{ route('supplier.create') }}" class="btn btn-success"><span class="fas fa-plus"></span> Tambah Supplier</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->email }}</td>
                        <td>
                            <a class="btn btn-primary" href="{{ route('supplier.edit',$item->id) }}"><span class="fas fa-edit"></span></a>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('supplier.destroy', ':id') }}" method="POST" class="delete-form">
            @csrf
            @method('DELETE')
