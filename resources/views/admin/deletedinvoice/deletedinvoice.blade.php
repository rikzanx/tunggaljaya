  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{ config('app.name', 'Laravel') }} - Deleted Invoice</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="{{ route('deletedinvoice.create') }}" class="btn btn-success"><span class="fas fa-plus"></span> tambah invoice</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->duedate }}</td>
                        <td>
                            <a class="btn btn-success" href="{{ route('deletedinvoice.show',$item->id) }}" target="_blank"><span class="fas fa-eye"></span></a>
                            <a class="btn btn-warning" href="{{ route('show_proform',$item->id) }}" target="_blank"><span class="fas fa-eye"></span></a>
                            <a class="btn btn-primary" href="{{ route('deletedinvoice.edit',$item->id) }}"><span class="fas fa-edit"></span></a>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('deletedinvoice.destroy', ':id') }}" method="POST" class="delete-form">
            @csrf
            @method('DELETE')
