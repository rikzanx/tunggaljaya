  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{ config('app.name', 'Laravel') }} - List Prospect</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="{{ route('prospect.create') }}" class="btn btn-success"><span class="fas fa-plus"></span> Tambah Prospect</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('prospect.destroy', ':id') }}" method="POST" class="delete-form">
            @csrf
            @method('DELETE')
